...
void vec3f_add(float a[3], float b[3])
{
    b[0] = a[0] + b[0];
    b[1] = a[1] + b[1];
    b[2] = a[2] + b[2];
...
void vec3f_sub(float a[3], float b[3])
{
    b[0] = a[0] - b[0];
    b[1] = a[1] - b[1];
    b[2] = a[2] - b[2];
...
void vec3f_adds(float a[3], float b)
{
    a[0] += b;
    a[1] += b;
    a[2] += b;
...
void vec3f_subs(float a[3], float b)
{
    a[0] -= b;
    a[1] -= b;
    a[2] -= b;
...
void vec3f_scale(float v[3], float s)
{
    v[0] *= s;
    v[1] *= s;
    v[2] *= s;
...
void vec3f_mul(float a[3], float b[3])
{
    b[0] *= a[0];
    b[1] *= a[1];
    b[2] *= a[2];
...
vec3f vec3f_lerp_new(float a[3], float b[3], float t, float dest[3])
{
