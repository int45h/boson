...
void vec4f_add(float a[4], float b[4])
{
    b[0] = a[0] + b[0];
    b[1] = a[1] + b[1];
    b[2] = a[2] + b[2];
...
void vec4f_sub(float a[4], float b[4])
{
    b[0] = a[0] - b[0];
    b[1] = a[1] - b[1];
    b[2] = a[2] - b[2];
...
void vec4f_adds(float a[4], float b)
{
    a[0] += b;
    a[1] += b;
    a[2] += b;
...
void vec4f_subs(float a[4], float b)
{
    a[0] -= b;
    a[1] -= b;
    a[2] -= b;
...
void vec4f_scale(float v[4], float s)
{
    v[0] *= s;
    v[1] *= s;
    v[2] *= s;
...
void vec4f_mul(float a[4], float b[4])
{
    b[0] *= a[0];
    b[1] *= a[1];
    b[2] *= a[2];
...
vec4f vec4f_lerp_new(float a[4], float b[4], float t, float dest[4])
{
